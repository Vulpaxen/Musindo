<%@ Page Title="" Language="C#" MasterPageFile="~/View/MainView.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="KpopZstation.View.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container my-5">
        ...
        <asp:Button ID="btnRegister" class="btn btn-primary" runat="server" Text="Submit" OnClick="btnRegister_Click" />
    </div>
</asp:Content>
